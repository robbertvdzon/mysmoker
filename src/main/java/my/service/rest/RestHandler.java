...
public class RestHandler {
    ...
    private void defineRoutes(AmazonDynamoDB amazonDynamoDB) {
        ...
        put("/newsession", (req, res) -> addSession(writeService, res), gson::toJson);
        put("/add", (req, res) -> addSample(writeService, req, res), gson::toJson); // return 201 : change to POST
        post("/settemp/:temp", (req, res) -> setTemp(writeService, req), gson::toJson);

        delete("/removesession/:sessionId", (req, res) -> removeSession(writeService, req), gson::toJson);
    }
